...
import getExchanges from '~/src/lib/zilstream/getExchanges'
import { currencyFormat, numberFormat } from '~/src/utils/format'
              ...
              return (
                ...
                >
                  ...
                  <td className="px-2 py-4 flex items-center font-medium">
                    <Link href={`/exchanges/${exchange.slug}`} className="flex items-center">
