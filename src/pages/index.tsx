...
import LoadingChartBlock from '~/src/components/LoadingChartBlock'
import LoadingTokenRows from '~/src/components/LoadingTokenRows'
...
function Home() {
  ...
  const volume = tokenState.tokens.reduce((sum: number, current: Token) => {
