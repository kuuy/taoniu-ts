...
import getToken from '~/src/lib/zilstream/getToken'
...
import InlineChange from '~/src/components/InlineChange'
import ChartContainer from '~/src/components/ChartContainer'
import PriceDayRange from '~/src/components/PriceDayRange'
import { shortenAddress } from '~/src/utils/shorten'
import TVLChartContainer from '~/src/components/TVLChartContainer'
import MemberWrapper from '~/src/components/MemberWrapper'
import TokenHolders from '~/src/components/TokenHolders'
import TokenLiquidity from '~/src/components/TokenLiquidity'
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-2 py-2 text-left font-medium">
                          <Link href={`/exchanges/${pair.exchange?.slug}`} className="flex items-center">
