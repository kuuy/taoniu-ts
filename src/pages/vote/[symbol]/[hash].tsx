...
import getGovernanceSnapshot from '~/src/lib/zilliqa/getGovernanceSnapshot'
import getGovernanceSpaces from '~/src/lib/zilliqa/getGovernanceSpaces'
import { useRouter } from 'next/router'
import React, { useEffect, useMemo, useState } from 'react'
import { useSelector } from '~/src/store/store'
import { Token } from '~/src/types/token'
import { ProposalMessage } from '~/src/types/proposal'
...
import getGovernanceVotes from '~/src/lib/zilliqa/getGovernanceVotes'
import useMoneyFormatter, { toBigNumber } from '~/src/utils/useMoneyFormatter'
import { Vote } from '~/src/types/vote'
import BigNumber from 'bignumber.js'
import Link from 'next/link'
import LoadingSpaceHeader from '~/src/components/LoadingSpaceHeader'
import LoadingProposal from '~/src/components/LoadingProposal'
import { shortenAddress } from '~/src/utils/shorten'
import CastVote from '~/src/components/CastVote'
        ...
        {token ? (
          <div className="flex items-center gap-3 pt-8 pb-4">
            ...
            <div className="flex flex-col">
              <Link href={`/vote/${space?.symbol.toLowerCase()}`} className="font-normal">
