...
import { CARBSWAP_ADDRESS, XCADDEX_ADDRESS, ZILALL_ADDRESS, ZILSWAP_ADDRESS } from '~/src/constants'
import { StakingContract } from '~/src/lib/staking/staking'
import { Token } from '~/src/types/token'
import { NftCollection } from '~/src/types/collection'
import { Operator } from '~/src/types/account'
import { Network } from '~/src/types/network'
import { MainnetNode, TestnetNode } from './mainnetNode'
 ...
 */
export const sendBatchRequest = async (requests: BatchRequest[], network: Network = Network.MainNet, node: MainnetNode|TestnetNode = MainnetNode.ZilStream, ): Promise<BatchResponse[]> => {
